...
import { Input, Button, CustomCard, CardContent, CardTitle, CardHeader, inputErrors, FormErrors, NotAuthorized } from "@/components";
import { FormField, FormItem, FormLabel, FormControl, FormDescription, FormMessage, Form } from "@/components/ui/form";
import { z } from "zod"
import { zodResolver } from "@hookform/resolvers/zod"
import { toast } from "sonner";
import { useForm } from "react-hook-form";
import { IUser, useUserStore } from "../..";
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-3xl font-bold">{actionTitle} Usuario</h1>
